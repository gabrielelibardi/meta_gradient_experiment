...
class MetaPPO:
    def __init__(self,
        ...
        self.optimizer = optim.Adam(self.actor_critic.policy.parameters(), lr=lr, eps=eps)
                                    
        self.meta_optimizer = optim.Adam(self.actor_critic.meta_net.parameters(), lr=meta_lr, eps=eps) # change this
